...
///
/// É o que impede duas réplicas do worker de processarem a mesma
/// varredura: sem isso, as duas leriam a mesma planilha da pasta e cada
/// uma a enviaria ao conversor com um ArquivoID próprio — dois CNABs do
/// mesmo cliente, e a corrida de File.Move só derruba uma das réplicas
/// DEPOIS do envio feito. O banco é o único ponto que todas as réplicas
/// já compartilham, então o lock mora nele; não precisa de
/// Redis/ZooKeeper pra isso.
///
...
/// perdedora pula a varredura em vez de enfileirar atrás da vencedora e
/// varrer tudo de novo logo depois.
/// </summary>
